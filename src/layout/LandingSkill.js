...
function LandingSkill() {
  return (
    ...
    <Container maxW="container.xl" p="7"  >
      <SimpleGrid  w="100%" templateColumns={{ sm: "1fr", md: "5fr 3fr" }} alignItems={"center"} spacing={5} h={{ base: "auto", md: "auto" }}>
        <Flex h={"100%"} w={"100%"} alignItems={"center"} justifyContent={"center"}>
          ...
          <Box h={"100%"} className="skill_s" mr={"2rem"}>
            ...
            <p><Icon as={BsFillCheckCircleFill} color={"#1D4044"} fontSize="12px" mr="10px" />Chakra UI/Tailwind</p>
            <p><Icon as={BsFillCheckCircleFill} color={"#1D4044"} fontSize="12px" mr="10px" />Javascript/Jquery</p>
          </Box>
          <Box h={"100%"} className="skill_s" mr={"2rem"}>
            <h4>Others</h4>
            <p><Icon as={BsFillCheckCircleFill} color={"#1D4044"} fontSize="12px" mr="10px" />Gitlab/GitHub</p>
